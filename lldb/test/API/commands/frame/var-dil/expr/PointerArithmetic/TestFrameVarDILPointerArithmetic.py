...
class TestFrameVarDILPointerArithmetic(TestBase):
    ...
    def test_arithmetic(self):
        ...
        # self.expect_var_path("p_void - 1"), IsError("arithmetic on a pointer to void")
        # self.expect_var_path("p_void - p_char1"),
        #             IsError("'void *' and 'const char *' are not pointers to "
        #                     "compatible types")
        # self.expect_var_path("p_void - p_void"),
        #             IsError("arithmetic on pointers to void")

        # self.expect_var_path("pp_void0 - p_char1"),
        #             IsError("'void **' and 'const char *' are not pointers to "
        #                     "compatible types")
        # self.expect_var_path("pp_void0 == p_char1"),
